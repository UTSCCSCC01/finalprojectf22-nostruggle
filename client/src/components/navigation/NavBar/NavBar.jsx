...
const NavBar = () => {
    ...
    return (
        <>
            ...
            { openMenu && <ListMenu className='UserMenu' type='link' items={[ 'Profile', 'My Posts', 'Sign Out' ]} path={{ 'Profile': `/profile/${userState.user.username}`, 'My Posts': `posts/${userState.user.username}`, 'Sign Out': '/logout' }}/> }
        </>
    )
}
